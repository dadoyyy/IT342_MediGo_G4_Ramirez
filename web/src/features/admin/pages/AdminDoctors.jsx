...
import { Stethoscope, Mail, Search, X, MapPin, Briefcase, CheckCircle2 } from 'lucide-react';
              ...
              <motion.div initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.95, opacity: 0 }}
                ...
                <div style={{ padding: 32 }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                    ...
                    <div>
                      <p style={{ fontSize: 11, fontWeight: 700, color: '#8D99AE', letterSpacing: '0.05em', margin: '0 0 8px' }}>CONTACT INFO</p>
                ...
                <div style={{ padding: '20px 32px', background: 'rgba(43,45,66,0.02)', borderTop: '1px solid rgba(43,45,66,0.06)', display: 'flex', justifyContent: 'flex-end' }}>
                  <button onClick={() => setSelectedDoctor(null)} className="mg-btn" style={{ padding: '10px 24px', fontSize: 13 }}>Close Details</button>
                </div>
              </motion.div>
            </motion.div>
          )}
