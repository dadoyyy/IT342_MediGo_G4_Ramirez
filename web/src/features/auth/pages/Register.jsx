      ...
      <div className="flex-1 flex items-center justify-center bg-gray-50 px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <div className="space-y-2 mb-8">
            ...
            <p className="text-gray-500 text-sm">Sign up to get started with MediGo</p>
          </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className={`w-full rounded-xl border bg-white px-4 py-3 text-sm min-h-[44px] transition-all outline-none focus:ring-2 ${
                    fieldErrors.firstName ? 'border-red-300 focus:ring-red-100 focus:border-red-400' : 'border-gray-200 focus:ring-rose-100 focus:border-rose-400'
                  }`}
                />
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className={`w-full rounded-xl border bg-white px-4 py-3 text-sm min-h-[44px] transition-all outline-none focus:ring-2 ${
                    fieldErrors.lastName ? 'border-red-300 focus:ring-red-100 focus:border-red-400' : 'border-gray-200 focus:ring-rose-100 focus:border-rose-400'
                  }`}
                />
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full rounded-xl border bg-white px-4 py-3 pr-12 text-sm min-h-[44px] transition-all outline-none focus:ring-2 ${
                    fieldErrors.confirmPassword ? 'border-red-300 focus:ring-red-100 focus:border-red-400' : 'border-gray-200 focus:ring-rose-100 focus:border-rose-400'
                  }`}
                />
